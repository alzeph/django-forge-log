...
2. Déplacer le contenu de `## [Unreleased]` dans `CHANGELOG.md` **et**
   `CHANGELOG.fr.md` sous une nouvelle section `## [X.Y.Z] - AAAA-MM-JJ`,
   et mettre à jour les liens de comparaison en bas de chaque fichier.
